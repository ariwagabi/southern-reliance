    ...
    $('body').on('click', '.card-activate', function (e) {
        ...
        if (selectedCards != null && selectedCards != '') {
            ...
            $.ajax({
                ...
                data: {
                    cards_selected: selectedCards.join(),
...
$(document).ready(function () {
   ...
   */
    ...
    function addCidToButtons() {
        $('a.btn[href!=""]').not("[href^='#']").each(function () {
    ...
    function init() {
        $('a[href]').not(".external-link").each(function () {
            var link = $(this).attr("href");
        ...
        addCidToButtons();
        $('a.external-link').not("[data-link]").each(function () {
            var link = $(this).attr("href");
            $(this).attr('data-link', link);

        });
        $('a.external-link').filter("[data-link]").each(function () {
            //var link = $(this).attr("href");
    ...
    $("#defaultmenu").on('click', 'a', function (event) {
        $this = $(this);
        console.log($this);
    ...
    function openModal(linkElem) {
        if (linkElem.hasClass("external-link")) {


            try {
                var targetUrl = linkElem.attr("data-link");
...
$(document).ready(function () {
    ...
    function setFrameWidth() {
        ...
        iframes.each(function () {
            ...
            var tabletHeight = $this.attr('data-tablet-height');
            var mobileHeight = $this.attr('data-mobile-height');
            var desktopHeight = $this.attr('data-desktop-height');
